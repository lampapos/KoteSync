...
- (BOOL)start:(NSError **)error {
    ...
    if(YES == successful) {
        ...
        addr4.sin_port = 8281; // since we set it to zero the kernel will assign one for us
...
- (void)_streamEncounteredEnd:(NSStream *)stream {
   ...
   [self performSelector:@selector(_publishNetService) withObject:nil afterDelay:1];
